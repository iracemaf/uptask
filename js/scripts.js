            ...
            if(this.status === 200) {
                ...
                if(resultado === 'correcto') {
                    ...
                    if(tipo === 'crear') {
                       ...
                       // Limpiar el formulario (elimina los datos capturados en el textbox)
...
function accionesTareas(e) {
    e.preventDefault();
    // Delegation checa a que elemento se hizo un click
    ...
    if(e.target.classList.contains('fa-trash')) {
        swal({
          ...
          if (result.value) {
              // traversing para obtener un dato de un elmento padre
